...
.. list-table::
   ...
   * - RoboCasa
     - ``robocasa_closedrawer``、``robocasa_opendrawer``、``robocasa_closedoubledoor`` 等 9 个原子任务，以及 ``robocasa_atomic_suite``
     - ``robocasa/robocasa_closedrawer_xr1_eval.yaml``、``robocasa/robocasa_atomic_suite_xr1_eval.yaml`` 等
   * - RoboCasa365
